  ...
  return (
    <div className="top-section-p container-margin-compact">
      <div className="flex flex-col gap-16 md:gap-32">
        <div className="flex flex-col items-center gap-12 sm:justify-between md:flex-row">
        ...
        <div className="flex flex-col-reverse items-center gap-12 sm:justify-between md:flex-row ">
          <div className="flex flex-col gap-1 w-full md:min-w-[450px] md:max-w-[600px] ">
            <h1 className="mb-3 text-2xl font-bold font-lato sm:text-3xl md:mb-4 lg:text-4xl lg:leading-tight text-black-shade-300">
