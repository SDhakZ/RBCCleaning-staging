...
/* export const metadata = {
  ...
  description:
    "These terms of service and disclaimer govern your use of the RBC Cleaning website and any content, features, or services made available through the website.",
  keywords: ["RBC Cleaning", "terms and conditions", "policy"],
  alternates: {
    canonical: "/terms-and-conditions",
  },
  openGraph: {
    title: "Terms and conditions | RBC Cleaning",
    description:
      "These terms of service and disclaimer govern your use of the RBC Cleaning website and any content, features, or services made available through the website.",
    images: [
      { url: "/OpengraphAlt2.png", width: 1800, height: 1600, alt: "RBC Cleaning" },
      { url: "/Opengraph.png", width: 1200, height: 630, alt: "RBC Cleaning" },
      { url: "/OpengraphAlt.png", width: 800, height: 600, alt: "RBC Cleaning" },
    ],
      ...
      <div className="flex flex-col gap-10 padding-y-lg container-margin-compact">
        <div className="flex flex-col gap-3">
          ...
          <p className="max-w-5xl text-lg font-medium font-manrope text-black-shade-100">
            These terms of service and disclaimer govern your use of the RBC
            Cleaning website and any content, features, or services made
